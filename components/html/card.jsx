export default function Card(props){
    ...
    if ( props.demo_url )
    {
        demoLink = ( <span className="font-thin text-base ml-6"> 
                        <a className="inline-flex" href={ props.demo_url } >Demo <img className="ml-1 w-4" src="./link_2.svg" /> </a>
                     </span> );
    }
                ...
                <div className="bg-gray-200 p-6 rounded-lg shadow-xl">
                    ...
                    <div className="mt-4">
                        ...
                        <span className="font-thin text-base"> 
                            <a className="inline-flex" href={ props.source_url } >Source <img className="ml-1 w-4" src="./link_2.svg" /> </a>
                        </span>
